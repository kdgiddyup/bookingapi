...
if ($requested === "all" || $requested === "test") {
    ...
    $allResults["beaufort"] = number_format(count($data[0]['data']));
    ...
    if ($requested != "test") {
        ...
        $allResults["lexington"] = number_format(count($data[0]['data']));
    }; // end of this is not a test condition
    echo "Processed $allResults[beaufort] records for Beaufort County Detention Center.\nProcessed $allResults[lexington] records for Lexington County Detention Center.";
}
